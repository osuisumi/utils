...
public class HttpClientUtils {
    ...
    public static JSONObject doGet(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        ...
        try {
            // 执行请求并获得响应结果
            return getJSONObject(httpResponse, httpClient, httpGet);
        } finally {
            // 释放资源
    ...
    public static JSONObject doPost(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        ...
        try {
            // 执行请求并获得响应结果
            return getJSONObject(httpResponse, httpClient, httpPost);
        } finally {
            // 释放资源
            release(httpResponse, httpClient);
        }
    ...
    public static JSONObject doPost(String url,String stringEntity) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
     ...
     * @throws Exception
     */
    public static JSONObject doPut(String url, Map<String, String> params) throws Exception {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        ...
        try {
            return getJSONObject(httpResponse, httpClient, httpPut);
        } finally {
            release(httpResponse, httpClient);
        }
    }
    ...
    public static JSONObject doDelete(String url) throws Exception {
        ...
        CloseableHttpResponse httpResponse = null;
        try {
            return getJSONObject(httpResponse, httpClient, httpDelete);
        } finally {
            release(httpResponse, httpClient);
        }
    }
     ...
     * @throws Exception
     */
    public static JSONObject doDelete(String url, Map<String, String> params) throws Exception {
        if (params == null) {
     ...
     * @throws Exception
     */
    public static JSONObject getJSONObject(CloseableHttpResponse httpResponse,
